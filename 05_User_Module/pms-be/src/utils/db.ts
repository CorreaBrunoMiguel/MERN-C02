...
export class DatabaseUtil {
   ...
   * Id an instance already exists, it returns the existing instance.
   * @returns A promisse that resolves to the singleton instance of DatabaseUtil
   */
  public static async getInstance(): Promise<DatabaseUtil> {
    ...
    // Return the singleton instance of DatebaseUtil
    return DatabaseUtil.instance;
  }

  /**
   * Estabilish a database connection or returns the esistig connection if available.
